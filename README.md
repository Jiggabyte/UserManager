...
* Clone the repository by entering the command `git clone https://github.com/Jiggabyte/UserManager` in the terminal.
* Navigate to the project folder using `cd UserManager` on your terminal (or command prompt)
* After cloning, type in terminal prompt 'bash deploy'.
